...
RUN set -x \
        ...
        && apt-get install -y wget unzip bzip2 psmisc ca-certificates openssl curl libpcre3 libxml2 libfreetype6 --no-install-recommends \
        # && apt-get install -y  sendmail binutils libreadline6 readline-common \
