...
RUN set -x \
        ...
        && apt-get install -y wget unzip bzip2 psmisc binutils ca-certificates openssl curl libpcre3 libxml2 libfreetype6 --no-install-recommends \
        # && apt-get install -y  sendmail  libreadline6 readline-common \
